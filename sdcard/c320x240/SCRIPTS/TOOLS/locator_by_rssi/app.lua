    ...
    lvgl.build({
        ...
        {type="box", x=0, y=30*lvSCALE,
            children={
                ...
                -- draw gauge bar
                {type="arc", x=220*lvSCALE, y=130*lvSCALE,
                    radius=80*lvSCALE, thickness=25*lvSCALE,
                ...
                -- draw current value
                {type="label", x=190*lvSCALE, y=90*lvSCALE, color=WHITE, font=FS.FONT_38,
                    text=function() return signalPercent end,
                },
                {type="label", x=210*lvSCALE, y=140*lvSCALE, color=WHITE, font=FS.FONT_16,
                    text="%",
                },
        ...
        {type="box", x=0, y=30*lvSCALE,
            children={
                ...
                {type="label", x=30*lvSCALE, y=150*lvSCALE, text="No signal found \nwaiting for: RSSI/1RSS/2RSS", color=RED, font=FS.FONT_12},
            },
            visible=function()
                return getRSSI() == 0
            end
