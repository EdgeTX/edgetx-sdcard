...
function M.init(box)
    box:build({
        ...
        {type="choice", x=x2, y=40, w=safe_width(x2+100, 80), color=COLOR_THEME_SECONDARY3,
            label="Switch",
            default=dr_switch,
            values=switch_names,
        ...
        -- Expo setting
        {type="label", text="Expo", x=x1, y=85, color=BLACK},
        {type="numberEdit", x=x2, y=80, w=60, min=0, max=100,
            default=expo,
