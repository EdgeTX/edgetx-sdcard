---------------------------------------------------------------------------
-- SoarETX F3K-FH configure mixes and battery warning                    --
--                                                                       --
...
do
  function gui.fullScreenRefresh()
    ...
    lcd.drawTextLines(MARGIN, bottom + 15, LCD_W - 2 * MARGIN, LCD_H - bottom, txt, colors.primary1)
  end
  ...
  -- ADD GVs
  addGV("Elevator input", 7, 20, 100)
  addGV("Aileron input", 0, 10, 100)
  addGV("Aileron " .. CHAR_RIGHT .. " flaps", 1, 0, 100)
  addGV("Aileron " .. CHAR_RIGHT .. " rudder", 2, 0, 100)
  addGV("Differential", 3, -100, 100)
  addGV("Brake " .. CHAR_RIGHT .. " elevator", 4, 0, 40)
  addGV("Snap - flap", 5, 0, 50)
  addGV("Camber " .. CHAR_RIGHT .. " aileron", 6, 0, 200)
  addGV("Exponential", 8, 0, 100)
