...
local function createModel(event)
  ...
  if TypeFields[1][5] == 0 then
    model.insertMix(4, 0,{source=110,name="Gyr",weight=25})
  else
    model.insertMix( 4, 0,{source=110,name="HH",weight=25})
    model.insertMix( 4, 1,{source=110,name="Rat",weight=-25,switch=gyRate+1,multiplex=2})
  end
