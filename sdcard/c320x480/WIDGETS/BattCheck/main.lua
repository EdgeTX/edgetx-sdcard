...
local function refreshZoneMedium(wgt)
  ...
  -- draw values
  lcd.drawText(wgt.zone.x, wgt.zone.y + 80, string.format("%2.1fV", wgt.mainValue), DBLSIZE + wgt.text_color + wgt.shadowed + wgt.no_telem_blink)
  ...
  if wgt.zone.h > 80 then
    ...
    lcd.drawText(wgt.zone.x, wgt.zone.y + 110, string.format("dV %2.2fV", wgt.cellMax - wgt.cellMin), SMLSIZE + wgt.text_color + wgt.no_telem_blink)
    lcd.drawText(wgt.zone.x, wgt.zone.y + 124, string.format("Min %2.2fV", wgt.cellDataHistoryCellLowest), SMLSIZE + wgt.text_color + wgt.no_telem_blink)
  end
  ...
  lcd.drawText(wgt.zone.x + myBatt.x, wgt.zone.y + myBatt.y + 55, string.format("%2.0f%%", wgt.cellPercent), LEFT + MIDSIZE + WHITE + wgt.shadowed)
...
local function refreshAppModeImpl(wgt, x, w, y, h)
  ...
  lcd.drawText(x + w, y + myBatt.y + 150, wgt.cellPercent .. "%", RIGHT + DBLSIZE + wgt.text_color + wgt.shadowed + wgt.no_telem_blink)

  lcd.drawText(x + 10, y + myBatt.y + 150, string.format("%2.1fV", wgt.mainValue), DBLSIZE + wgt.text_color + wgt.shadowed + wgt.no_telem_blink)
  lcd.drawText(x + 10, y + myBatt.y + 205, string.format("%2.1fV %dS", wgt.secondaryValue, wgt.cellCount), SMLSIZE + wgt.text_color + wgt.shadowed + wgt.no_telem_blink)
