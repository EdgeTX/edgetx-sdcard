...
local function drawEngineMenu()
  ...
  if engineMode == 1 then
    -- 1 channel
    lcd.drawPixmap(132, 8, "img/plane/engine-1.bmp")
    ...
    -- No engine
    lcd.drawPixmap(132, 8, "img/plane/engine-0.bmp")
    fieldsMax = 0
  end
end
...
local function drawAileronsMenu()
  ...
  if aileronsMode == 2 then
    -- 2 channels
    lcd.drawPixmap(112, 8, "img/plane/ailerons-2.bmp")
  ...
  elseif aileronsMode == 1 then
    -- 1 channel
    lcd.drawPixmap(112, 8, "img/plane/ailerons-1.bmp")
    lcd.drawText(25, LCD_H-16, "Assign channel", 0);
    lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
    ...
    -- No ailerons
    lcd.drawPixmap(112, 8, "img/plane/ailerons-0.bmp")
    fieldsMax = 0
  end
end
...
local function drawFlapsMenu()
  ...
  elseif flapsMode == 1 then
    -- 1 channel
    lcd.drawPixmap(112, 8, "img/plane/flaps-1.bmp")
    lcd.drawText(25, LCD_H-16, "Assign channel", 0);
    lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  ...
  elseif flapsMode == 2 then
    -- 2 channels
    lcd.drawPixmap(112, 8, "img/plane/flaps-2.bmp")
    lcd.drawText(20, LCD_H-16, "Assign channels", 0);
    lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawBrakesMenu()
  ...
  elseif brakesMode == 1 then
    -- 1 channel
    lcd.drawPixmap(112, 8, "img/plane/brakes-1.bmp")
    lcd.drawText(25, LCD_H-16, "Assign channel", 0);
    lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  ...
  elseif brakesMode == 2 then
    -- 2 channels
    lcd.drawPixmap(112, 8, "img/plane/brakes-2.bmp")
    lcd.drawText(20, LCD_H-16, "Assign channels", 0);
    lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
...
local function drawTailMenu()
  ...
  if tailMode == 0 then
    ...
    lcd.drawPixmap(112, 8, "img/plane/tail-e.bmp")
    lcd.drawText(25, LCD_H-16, "Assign channel", 0);
    lcd.drawSource(175, 30, MIXSRC_CH1+eleCH1, getFieldFlags(1))
    fieldsMax = 1
  elseif tailMode == 1 then
    -- Elevator(1ch) + rudder...
    lcd.drawPixmap(112, 8, "img/plane/tail-er.bmp")
    lcd.drawText(20, LCD_H-16, "Assign channels", 0);
    lcd.drawSource(175, 30, MIXSRC_CH1+eleCH1, getFieldFlags(1))
  ...
  elseif tailMode == 2 then
    -- Elevator(2ch) + rudder...
    lcd.drawPixmap(112, 8, "img/plane/tail-eer.bmp")
    lcd.drawText(20, LCD_H-16, "Assign channels", 0);
    lcd.drawSource(175, 30, MIXSRC_CH1+eleCH1, getFieldFlags(1))
    ...
    -- V-Tail...
    lcd.drawPixmap(112, 8, "img/plane/tail-v.bmp")
    lcd.drawText(20, LCD_H-16, "Assign channels", 0);
...
local function drawServoMenu(limits)
  ...
  lcd.drawText(LCD_W/2-19, LCD_H-8, ">>>", 0);
  lcd.drawPixmap(122, 8, "img/plane/servo.bmp")
...
local function drawConfirmationMenu()
  ...
  lcd.drawPixmap(LCD_W-18, LCD_H-17, "img/plane/confirm-tick.bmp")
  fieldsMax = 0
end
